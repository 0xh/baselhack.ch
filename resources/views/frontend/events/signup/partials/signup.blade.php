    ...
    <div class="field">
        ...
        <label class="label">{{ __('frontend/event.signup.form.input.company') }}
            ...
            <span style="font-size: 9px;"
                  class="tag is-dark is-pulled-right is-uppercase">optional</span>
        ...
        <div class="column is-5">
            ...
            <div class="field">
                <label style="margin-top: 20px;" class="checkbox">
                    ...
                    {{ __('frontend/event.signup.form.input.accept_policty_start') }} <a
                            target="_blank"
        ...
        <div class="column">
            <div class="field {{ $errors->has('g-recaptcha-response') ? ' is-danger' : '' }}">
                <div class="g-recaptcha"
                     data-sitekey="6LeXkG8UAAAAANeVjDf6hPjY7KnMwyhZtKSstIUg"></div>
