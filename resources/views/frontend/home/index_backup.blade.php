                    ...
                    <div class="row cols-xs-space align-items-center text-center text-md-left justify-content-center">
                        <div class="col-7">
                            <div class="text-center mt-5">
                                <img src="{{ asset('images/brand/icon.png') }}" style="width: 200px;" class="img-fluid animated" data-animation-in="jackInTheBox" data-animation-delay="1000">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <div class="row-wrapper">
                        ...
                        <img src="{{ asset('images/prv/thumb-1.jpg') }}" class="avatar avatar-lg mr-3">
                        ...
                        <img src="{{ asset('images/prv/thumb-1.jpg') }}" class="avatar mr-3">
                        <span class="clearfix"></span>
                        ...
                        <img src="{{ asset('images/prv/thumb-1.jpg') }}" class="avatar avatar-sm">
                    </div>
                    <!-- Navbar -->
                    <div class="row align-items-center mb-4 mt-lg">
                        <div class="col-8">
