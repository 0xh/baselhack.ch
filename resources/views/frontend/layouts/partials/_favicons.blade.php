...
<link rel="apple-touch-icon" sizes="180x180" href="{{ asset('frontend/favicons/apple-touch-icon.png') }}">
...
<link rel="manifest" href="{{ asset('frontend/favicons/site.webmanifest') }}">
